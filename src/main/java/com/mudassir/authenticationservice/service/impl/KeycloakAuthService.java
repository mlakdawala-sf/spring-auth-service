...
public class KeycloakAuthService {
        ...
        public String login(String code) {
                ...
                KeycloakUserDTO keycloakUserDTO = this.keycloakFacadeService
                                .getKeycloakUserProfile(keycloakAuthResponse.getAccess_token());
                ...
                Optional<UserCredential> userCredential = this.userCredentialRepository
